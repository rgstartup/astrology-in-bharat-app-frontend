...
const menuItems: MenuItem[] = [
  ...
  { label: "Appointment", href: "/astrologer/dashboard/appointment", icon: CalendarCheck },
  {
    label: "Service & Pricing",
    href: "/astrologer/dashboard/service-pricing",
    icon: Coins,
  },
  {
    label: "Clients History",
    href: "/astrologer/dashboard/client-history",
    icon: History,
  },
  { label: "Earnings", href: "/astrologer/dashboard/earnings", icon: Coins },
  {
    label: "Account",
    href: "#",
    icon: Settings,
    submenu: [
      {
        ...
        href: "/astrologer/dashboard/profilemanagement",
        icon: User,
      },
