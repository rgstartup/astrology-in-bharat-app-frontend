    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: 1,
            sender: "user",
            text: "Namaste, Guruji. I'm feeling very anxious about the career path. What my stars say?",
            time: "10:48 AM",
        ...
        },
        {
            id: 2,
            sender: "astrologer",
            text: "Namaste, Avni. Let's look horoscope. Please provide date of birth, time, and place of birth.",
            time: "10:49 AM",
        },
        {
            id: 3,
            sender: "astrologer",
            text: "Namaste. Thank. Just a moment while I check Mars and placements. Your Mars and Saturn indicate a challenge but also immense growth.",
            time: "10:50 AM",
        ...
        },
        {
            id: 4,
            sender: "user",
            text: "August 20, 1995, time, and a 3:45 PM, Mumbai",
            time: "10:51 AM",
            avatar: "/images/user-avatar.jpg",
        },
         {
            id: 5,
            sender: "user",
            text: "Shadi kb tk hoygi sir meri",
            time: "10:52 AM",
            avatar: "/images/user-avatar.jpg",
        },
         {
            id: 6,
            sender: "astrologer",
            text: "Mitter teri to ni hoti kabhi",
            time: "10:53 AM",
            avatar: "/images/astrologer-avatar.jpg",
        },
         {
            id: 7,
            sender: "user",
            text: "Sir Mai apki complaint kr dunga",
            time: "10:54 AM",
            avatar: "/images/user-avatar.jpg",
        },
         {
        ...
        <div className="flex flex-col  bg-transparent font-poppins relative">
            ...
            <div className="bg-white rounded-t-2xl shadow-sm p-8 flex flex-col sm:flex-row items-center justify-between border-b border-gray-100 z-10 sticky top-0">
                <div className="flex items-center gap-3 mb-2 sm:mb-0 w-full sm:w-auto">
                    <div>
                        <h2 className="text-lg font-semibold text-gray-800">Live Chat with Avni Pandit</h2>
                ...
                <div className="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-end">
                    ...
                    <div className="flex items-center gap-2">
                        {[Mic, Video, Headphones, Menu].map((Icon, idx) => (
                            <button key={idx} className="p-2 hover:bg-gray-100 rounded-full text-gray-500 transition-colors" aria-label="Control">
                                <Icon size={20} />
                            </button>
                        ))}
                        <button className="p-2 hover:bg-red-50 text-red-500 rounded-full transition-colors ml-1" aria-label="Close">
                            <X size={20} />
                        </button>
                    </div>
                </div>
            ...
            <div className="bg-white p-4 border-t border-gray-100 rounded-b-2xl shadow-sm">
                <div className="flex items-center gap-3 bg-white p-1">
                    <button className="p-2 text-gray-400 hover:text-gray-600 transition-colors" aria-label="Attach">
                        <Paperclip size={20} />
                    </button>
