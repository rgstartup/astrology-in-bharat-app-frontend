...
const FamousPlacesPage = () => {
    ...
    const load = async () => {
      ...
      try {
        const [t, p] = await Promise.all([
          fetchPlaces(
            DEFAULT_QUERIES.temples.q,
            DEFAULT_QUERIES.temples.location,
          ),
          fetchPlaces(
            DEFAULT_QUERIES.pilgrimages.q,
            DEFAULT_QUERIES.pilgrimages.location,
          ),
        ]);
  ...
  const handleCategorySelect = async (
    cat: (typeof TEMPLE_CATEGORIES)[number],
  ) => {
        ...
        {searchResults.length > 0 && (
          <section className="mb-10">
            <div className="flex items-center justify-between mb-5">
              ...
              <button
                onClick={clearSearch}
                className="text-sm text-gray-400 hover:text-orange-500 flex items-center gap-1 font-medium"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-10">
            <PlacesSection
              ...
              headerIcon={
                <Image
                  src="/images/temple-icon-header.png"
                  alt="Popular Temples"
                  width={40}
                  height={40}
