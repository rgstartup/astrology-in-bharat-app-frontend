          ...
          {isLoading && (
            <div className="space-y-6">
              <p className="text-slate-400 font-bold italic text-lg leading-relaxed px-4">
                &quot;Just a moment while we align your profile with our stellar
                database.&quot;
              </p>
          ...
          {error && (
            <div className="p-8 bg-red-50/50 rounded-[2rem] border border-red-100 space-y-4">
              ...
              <p className="text-slate-500 text-xs font-bold leading-relaxed">
                Please ensure you are using the correct link from your email or
          ...
          {successMessage && (
            <div className="p-10 bg-green-50/50 rounded-[2.5rem] border border-green-100 space-y-6">
              <div className="space-y-2">
                <h4 className="text-green-950 font-black text-xl uppercase tracking-tighter">
                  Awesome!
                </h4>
