      ...
      <div className="sticky top-28">
        <div className="p-2 bg-white border border-[#F0E0D0] rounded-[3.5rem] shadow-[0_4px_25px_rgba(0,0,0,0.05)] relative overflow-hidden">
          ...
          <div className="relative h-[380px] rounded-[3rem] overflow-hidden group">
            ...
            {/* Price Badge */}
            <div className="absolute top-6 right-6 px-4 py-2 bg-[#FF5500] rounded-full shadow-lg flex items-center gap-2">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-[#FFF8F3] rounded-2xl border border-[#F5E0CC]">
                ...
                <button
                  ...
                  className="px-4 py-2 text-xs font-bold text-[#FF5500] hover:bg-orange-50 rounded-xl transition-colors cursor-pointer"
                >
                  {tx("change")}
                </button>
              </div>
              ...
              {/* Someone Else Form */}
              {!askSomeoneElse && (
                <div className="p-6 rounded-[2rem] bg-white border-2 border-orange-200 shadow-sm space-y-4 animate-in fade-in slide-in-from-top-4 duration-500">
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      <label className="text-[9px] font-black text-[#FF5500] uppercase tracking-widest ml-1 mb-1.5 block">
                        {tx("fullName")}
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-4 py-3 bg-white rounded-xl border border-gray-200 focus:border-[#FF5500] outline-none text-sm font-bold text-gray-900 shadow-sm transition-colors"
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 bg-white rounded-xl border border-gray-200 focus:border-[#FF5500] outline-none text-sm font-bold text-gray-900 shadow-sm appearance-none transition-colors"
                        >
              ...
              {isAuthenticated && eligibility !== null && (
                <div className="flex items-center justify-between px-6 py-4 bg-[#FFF8F3] rounded-2xl border border-[#F5E0CC]">
                  ...
                  <span className="text-xl font-black text-gray-900">
                    ₹{eligibility.currentBalance.toFixed(2)}
                  </span>
                </div>
              )}
              ...
              {showLowBalance ? (
                <div className="p-6 bg-red-50 rounded-3xl border border-red-100">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-red-900 leading-none mb-1">
                        {tx("lowBalance")}
                      </h4>
                ...
                <div className="relative group">
                  <div className="absolute -inset-2 bg-gradient-to-r from-[#FF8A00] to-[#FF5500] rounded-[45px] blur-2xl opacity-20 group-hover:opacity-40 transition-opacity duration-1000"></div>
                  ...
                  >
                    ...
                    <Sparkles
                      className="w-5 h-5 md:w-6 md:h-6 text-yellow-300 relative z-10 group-hover:scale-125 transition-transform duration-300"
                      fill="currentColor"
                    />
