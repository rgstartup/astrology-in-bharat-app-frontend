          ...
          <div className="flex items-center gap-1.5 md:gap-3">
            ...
            <div>
              <h1 className="font-bold text-[11px] md:text-sm leading-none text-white flex items-center gap-1.5">
                {expertData.name}
                {isFree && (
                  <span className="bg-[#1A1A1A] text-[#fd6410] px-2 py-1 rounded-md text-[10px] md:text-xs font-black uppercase tracking-widest shadow-md animate-bounce border border-[#fd6410]/20">
                    Free
                  </span>
                )}
              </h1>
