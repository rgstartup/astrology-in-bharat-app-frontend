          ...
          <div className="flex-1 w-full min-w-0">
            {loading ? (
              ...
              <>
                ...
                <GuidanceCTA
                  className="mt-8"
                  subtitle={t("detailsPage.ctaSubtitle")}
                  title={t("detailsPage.ctaTitle")}
                  description={t("detailsPage.ctaDesc")}
                  buttonText={t("detailsPage.ctaBtn")}
