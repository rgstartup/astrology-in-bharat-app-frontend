  ...
  return (
    ...
    >
      ...
      <p className="text-slate-600 text-[15px] md:text-base leading-relaxed mb-8">
        {lang === "hi"
          ? "यह दिन अवसरों और चुनौतियों का मिश्रण लेकर आता है। आपका आत्मविश्वास आपकी सबसे बड़ी संपत्ति होगी। अपने लक्ष्यों पर केंद्रित रहें और ध्यान भंग होने से बचें। सकारात्मक बदलाव आने वाले हैं।"
          : "The day brings a mix of opportunities and challenges. Your confidence will be your greatest asset. Stay focused on your goals and avoid distractions. Positive changes are on the way."}
      </p>
      ...
      <div className="flex flex-col divide-y divide-[#F0E6DD] border-t border-[#F0E6DD]">
        {horoscope.predictions.map((p: any, idx: number) => {
          ...
          return (
            <div
              key={idx}
              className="py-5 md:py-6 flex flex-col gap-3 transition-all"
            >
              ...
              >
                <div className="flex items-center gap-5 flex-1">
                  {/* Left Icon */}
                  <div
                    className={`w-12 h-12 md:w-14 md:h-14 rounded-full ${iconData.bg} flex items-center justify-center shrink-0`}
                  >
                    <i
                      className={`${iconData.icon} ${iconData.color} text-xl md:text-2xl`}
                    ></i>
                  </div>
                ...
                <div className="flex items-center gap-4 shrink-0">
                  ...
                  <button className="w-8 h-8 flex items-center justify-center text-slate-400 group-hover:text-[#F26500] transition-colors">
                    <i
                      className={`fa-solid fa-chevron-${isExpanded ? "up" : "down"} text-sm md:text-base`}
                    ></i>
                  </button>
                </div>
              </div>
