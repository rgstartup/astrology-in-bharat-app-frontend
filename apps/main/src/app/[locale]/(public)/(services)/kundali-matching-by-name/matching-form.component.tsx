        ...
        <div className="bg-white rounded-[2rem] border-2 border-orange-500 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-visible p-6 md:p-10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
            ...
            <button
              type="button"
              onClick={handleSwap}
              className="hidden md:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-white border-2 border-orange-500 shadow-sm items-center justify-center cursor-pointer hover:bg-orange-50 hover:scale-105 transition-all text-orange-500 ring-4 ring-white"
            >
              <HiOutlineSwitchHorizontal className="text-lg" />
              <span className="text-[10px] absolute -bottom-[18px] font-bold text-orange-500 bg-white px-1.5 rounded-full leading-none py-0.5">
                {t("form.swap")}
              </span>
            </button>
            ...
            <div className="rounded-2xl border-2 border-orange-500 bg-gradient-to-b from-blue-50/80 to-transparent overflow-visible">
              <div className="px-6 py-4 flex items-center gap-3">
                ...
                <h3 className="font-semibold text-slate-800 text-[14px] sm:text-base whitespace-nowrap sm:whitespace-normal tracking-tight sm:tracking-normal">
                  {t("form.boyTitle")}
                </h3>
              </div>
              ...
              <div className="p-6 space-y-5">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder={t("form.placeholders.boyName")}
                ...
                <div className="space-y-1.5">
                  ...
                  <LocationAutocomplete
                    placeholder={t("form.placeholders.searchPlace")}
              ...
              <div className="p-6 space-y-5">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder={t("form.placeholders.girlName")}
            ...
            <div className="md:hidden flex justify-center mt-2">
              <button
                type="button"
                onClick={handleSwap}
                className="flex items-center gap-2 px-4 py-2 rounded-full border border-orange-200 text-orange-500 text-sm font-medium"
              >
                <HiOutlineSwitchHorizontal /> {t("form.swapDetails")}
              </button>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 flex justify-center">
            <div className="flex flex-col items-center w-full max-w-md shrink-0">
              ...
              <button
                disabled={loading}
                onClick={handleMatch}
                className="w-full bg-[#f95700] hover:bg-[#e04f00] text-white rounded-xl py-4 px-6 font-semibold text-[15px] transition-colors flex items-center justify-center gap-2 shadow-[0_8px_20px_rgba(249,87,0,0.25)] cursor-pointer"
              >
                {loading ? (
                  <FaSpinner className="animate-spin" />
                ) : (
                  <HiOutlineSwitchHorizontal className="text-xl rotate-45" />
                )}
                {t("form.matchKundlis")}
              </button>
