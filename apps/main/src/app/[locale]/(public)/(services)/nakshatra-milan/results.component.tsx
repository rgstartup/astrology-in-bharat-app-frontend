          ...
          <div className="p-8 md:p-16 lg:p-24">
            ...
            <div className="text-center mb-20 space-y-8">
              <div className="inline-flex items-center gap-2 px-6 py-2 bg-indigo-50 rounded-full border border-indigo-100">
                ...
                <span className="text-[12px] font-black text-indigo-500 uppercase tracking-[.2em]">
                  Star Compatibility Final Analysis
                </span>
              </div>
              <h2 className="text-4xl md:text-6xl font-black text-gray-900 leading-tight">
                Celestial{" "}
                <span className="text-indigo-600 italic">Alignment</span>
              </h2>
            </div>
                ...
                <div className="relative z-10 space-y-10">
                  ...
                  <div className="flex flex-col items-center justify-center space-y-6">
                    <div className="flex items-baseline gap-4">
                      ...
                      <span className="text-4xl font-black text-indigo-500/50">
                        / {results.match.guna_milan.maximum_points}
                      </span>
                    </div>

                    <div
                      className={`px-10 py-3 rounded-2xl text-xs font-black uppercase tracking-[0.3em] flex items-center gap-4 border shadow-2xl transition-all ${
                ...
                <div className="h-full bg-white rounded-[3rem] p-10 shadow-premium border border-gray-100 transition-all duration-500 hover:shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      <div
                        key={idx}
                        className="p-6 bg-gray-50/50 rounded-2xl border border-gray-100 group hover:bg-white hover:border-indigo-500/20 transition-all"
                      >
                        <span className="text-[9px] font-black text-gray-400 uppercase tracking-[2px] block mb-2">
                          {item.label}
                        </span>
                        <span className="text-base font-black text-gray-900 italic block">
                ...
                <div className="h-full bg-white rounded-[3rem] p-10 shadow-premium border border-gray-100 transition-all duration-500 hover:shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      <div
                        key={idx}
                        className="p-6 bg-gray-50/50 rounded-2xl border border-gray-100 group hover:bg-white hover:border-orange/20 transition-all"
                      >
                        <span className="text-[9px] font-black text-gray-400 uppercase tracking-[2px] block mb-2">
                          {item.label}
                        </span>
                        ...
                        {(item.lord || item.planet) && (
                          <div className="mt-4 pt-4 border-t border-gray-100/50 flex justify-between items-center">
                            ...
                            <span className="text-[10px] font-black text-orange uppercase tracking-widest">
                              {item.lord || item.planet}
                            </span>
                          </div>
                        )}
                  ...
                  <div className="relative z-10 space-y-12">
                    <div className="inline-flex items-center gap-4 px-6 py-2 bg-white/5 backdrop-blur-md rounded-full border border-white/10">
                      ...
                      <span className="text-[10px] font-black text-white uppercase tracking-[0.4em]">
                        Expert Star Analysis Synthesis
                      </span>
                    </div>

                    <div className="max-w-4xl mx-auto space-y-8">
                      <h4 className="text-3xl md:text-5xl font-black text-white italic leading-tight">
                        &quot;The alignment of your birth stars influences
                        relationship{" "}
                        <span className="text-orange">harmony</span> & spiritual
                        growth.&quot;
                      </h4>
                    </div>
