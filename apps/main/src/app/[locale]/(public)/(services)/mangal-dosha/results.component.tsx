...
import { FaMars, FaCheckCircle, FaExclamationTriangle } from "react-icons/fa";
          ...
          <div className="p-8 md:p-16 lg:p-24">
            ...
            <div className="text-center mb-20 space-y-8">
              <div className="inline-flex items-center gap-2 px-6 py-2 bg-red-50 rounded-full border border-red-100">
                ...
                <span className="text-[12px] font-black text-red-500 uppercase tracking-[.2em]">
                  Mars Affliction Final Report
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch mb-20">
              ...
              <div className="lg:col-span-5">
                <div
                  className={`h-full rounded-[3rem] p-12 flex flex-col items-center justify-center text-center relative overflow-hidden shadow-2xl transition-all duration-700 ${
                    result.has_dosha
                ...
                >
                  ...
                  <div
                    className={`w-32 h-32 rounded-3xl flex items-center justify-center mb-8 relative z-10 shadow-2xl ${
                      result.has_dosha
              ...
              <div className="lg:col-span-7">
                <div className="bg-gray-50/50 rounded-[3rem] p-12 md:p-16 border border-gray-100 h-full flex flex-col justify-center">
                  ...
                  <div className="space-y-8">
                    ...
                    <div
                      className={`p-8 rounded-[2rem] border flex gap-6 items-start transition-all ${
                        result.has_dosha
                    ...
                    >
                      {result.has_dosha ? (
                        <FaExclamationTriangle className="text-red-500 text-2xl shrink-0" />
                      ) : (
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                      {result.exceptions.map((ex: any, idx: number) => (
                        <div
                          key={idx}
                          className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-6 group hover:border-emerald-500/20 transition-all"
                        >
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                      {result.remedies.map((rem: any, idx: number) => (
                        <div
                          key={idx}
                          className="bg-gray-900 p-6 rounded-2xl border border-gray-800 shadow-2xl flex items-center gap-6 group hover:bg-red-600 transition-all"
                        >
              ...
              <div className="relative z-10 space-y-8">
                ...
                <div className="max-w-3xl mx-auto space-y-6">
                  <h4 className="text-3xl md:text-5xl font-black text-white italic leading-tight">
                    &quot;The stars reflect a path of{" "}
                    <span className="text-red-500">balance</span> & spiritual
                    growth.&quot;
                  </h4>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-6 pt-10">
                  <button
                    ...
                    className="group/btn relative px-10 py-5 bg-white text-gray-900 rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-xl hover:scale-105 transition-all duration-300"
                  >
        ...
        <div className="mt-12 text-center opacity-30 grayscale hover:opacity-100 hover:grayscale-0 transition-opacity duration-700">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-[10px] font-black text-gray-900 uppercase tracking-[0.5em]">
              CERTIFIED ACCURATE ANALYSIS BY ASTROLOGY IN BHARAT
            </span>
          </div>
        </div>
      </div>
