  ...
  const features = [
    {
      icon: Flower2,
      text:
        lang === "hi" ? "वैदिक ज्योतिष के अनुसार" : "As per Vedic Astrology",
    },
    {
      icon: Sparkles,
      text: lang === "hi" ? "36 गुण मिलान प्रणाली" : "36 Gun Milan System",
    },
    {
      icon: ClipboardCheck,
      text: lang === "hi" ? "विस्तृत विश्लेषण" : "Detailed Analysis",
    },
  ];
          ...
          <div className="w-full md:w-[50%] p-6 md:p-10 lg:p-12 z-20 order-2 md:order-1 flex flex-col justify-center relative -mt-10 md:mt-0">
            ...
            <div className="flex flex-col items-center md:items-start mb-4">
              <h2 className="text-[#ffb286] text-xl md:text-2xl lg:text-[22px] font-serif mb-3 text-center md:text-left drop-shadow-md">
                {lang === "hi"
                  ? "अपनी ब्रह्मांडीय अनुकूलता खोजें"
            ...
            <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-10 text-center md:text-left max-w-md mx-auto md:mx-0 drop-shadow-md">
              {lang === "hi"
                ? "अपने भविष्य को एक साथ मार्गदर्शन देने के लिए प्राचीन ज्ञान।"
                : "Ancient wisdom to guide your future together."}
              <br />
              <span className="block mt-1">
                {lang === "hi"
                  ? "अपने रिश्ते की ब्रह्मांडीय सद्भावना खोजें।"
                  : "Discover the cosmic harmony of your relationship."}
              </span>
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-auto">
              {features.map((feat, idx) => {
                ...
                const word1 =
                  words[0] + (words.length > 2 ? " " + words[1] : "");
