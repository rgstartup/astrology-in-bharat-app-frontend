    ...
    <div className="min-h-screen bg-[#FDF6F0]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="max-w-[1320px] mx-auto px-4 md:px-8 lg:px-16 pb-4">
        <div className={`grid gap-6 ${result ? "lg:grid-cols-3 md:grid-cols-2" : "md:grid-cols-2 max-w-5xl"} mx-auto`}>
          ...
          {/* ── Middle: Result ── */}
          {result && (
            <div className="bg-gradient-to-br from-[#2A1110] to-[#1A0B0B] border border-[#F26500]/30 rounded-3xl p-6 md:p-8 flex flex-col items-center justify-center text-center shadow-xl relative overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
              {/* Decorative BG */}
