    ...
    <div className="max-w-7xl mx-auto px-4 pb-12 mt-8">
      <section className="bg-[#FFFDF9] rounded-3xl p-6 md:p-10 border border-[#F0E0D0] shadow-[0_4px_15px_0_rgba(0,0,0,0.03)]">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-10 rounded-r-xl">
          <h3 className="text-[17px] font-bold text-blue-900 mb-2 flex items-center gap-2">Why Perform {safeName} Online?
          </h3>
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#FAF8F5] border border-[#EAE2D6] p-6 rounded-2xl hover:shadow-md transition-shadow">
              ...
              <p className="text-[14px] text-slate-600 leading-relaxed">The intense vibrations of the mantras used during this puja help dissolve negative karma accumulated over lifetimes, removing unseen obstacles from your current path.</p>
            </div>
            <div className="bg-[#FAF8F5] border border-[#EAE2D6] p-6 rounded-2xl hover:shadow-md transition-shadow">
              <h4 className="font-bold text-[#FF5500] text-[17px] mb-2 flex items-center gap-2">Planetary Peace (Graha Shanti)
              </h4>
              <p className="text-[14px] text-slate-600 leading-relaxed">It neutralizes the negative impacts (Doshas) caused by unfavorable planetary transits in your birth chart, protecting you from sudden misfortunes.</p>
            </div>
            <div className="bg-[#FAF8F5] border border-[#EAE2D6] p-6 rounded-2xl hover:shadow-md transition-shadow">
              <h4 className="font-bold text-[#FF5500] text-[17px] mb-2 flex items-center gap-2">Mental Clarity & Calmness
              </h4>
              <p className="text-[14px] text-slate-600 leading-relaxed">The sacred smoke from the Havan and the continuous rhythmic chanting purify the surrounding aura, dramatically reducing anxiety, depression, and mental fog.</p>
            </div>
            <div className="bg-[#FAF8F5] border border-[#EAE2D6] p-6 rounded-2xl hover:shadow-md transition-shadow">
              <h4 className="font-bold text-[#FF5500] text-[17px] mb-2 flex items-center gap-2">Success & Prosperity
              </h4>
              <p className="text-[14px] text-slate-600 leading-relaxed">By clearing energetic blockages, this puja opens up new avenues for financial growth, career promotions, and harmony in personal relationships.</p>
            </div>
          </div>
        </div>
