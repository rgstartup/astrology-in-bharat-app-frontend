...
const { ChevronLeft, Phone, Video, User, Calendar, MapPin, ShieldCheck } =
  LucideIcons as any;
...
function CallPrepContent() {
  ...
  const [existingCallDetails, setExistingCallDetails] = useState<{
    sessionId: string;
    expertId: string;
  } | null>(null);
  const {
  ...
  const checkHardwareAndNetwork = async () => {
    ...
    try {
      ...
      if (!hasMic) {
        throw new Error(
          "No microphone detected. Please connect a mic to continue.",
        );
      }
  ...
  const proceedToCall = async () => {
    ...
    const [response, error] = await api.post<any>("/call/initiate", {
      expert_id: id,
      type: type,
    });
          ...
          <div className="lg:col-span-7 space-y-8">
            <div>
              ...
              <p className="text-gray-600 text-base md:text-lg leading-relaxed mt-4 font-medium tracking-tight">
                Experience a personal {type} consultation for precise future
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 rounded-3xl bg-white border-2 border-orange shadow-sm hover:shadow-lg transition-shadow">
                ...
                <h3 className="font-bold text-gray-900">
                  {type === "video" ? "HD Video" : "Crystal Clear Audio"}
                </h3>
                <p className="text-xs text-gray-500 mt-1">
                  High-quality connection for seamless talk.
                </p>
              </div>
              <div className="p-6 rounded-3xl bg-white border-2 border-orange shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Your identity and conversation are encrypted.
                </p>
              </div>
            </div>
            ...
            <div className="p-8 rounded-[2.5rem] bg-white text-gray-900 shadow-sm border-2 border-orange hover:shadow-lg transition-shadow">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  >
                    <div className="w-5 h-5 rounded-full border border-gray-200 text-gray-500 flex items-center justify-center text-[10px]">
                      {i + 1}
                    </div>
                    {item}
                  </li>
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-red-600 font-medium">
                          You need at least ₹{callPrice * 5} for 5 mins.
                        </p>
                      </div>
                    </div>
                    <button
          ...
          <div className="bg-white w-full max-w-lg rounded-[2rem] overflow-hidden shadow-2xl flex flex-col border-2 border-orange">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-xs font-medium">
                    Please follow these call guidelines
                  </p>
                </div>
              </div>
            </div>
            <div className="p-8 space-y-4">
              <p className="text-sm text-gray-700 leading-relaxed font-bold">
                1. Do not share your phone number or email address.
                <br />
                2. Avoid making payments outside our website.
                <br />
                3. If the expert asks for personal contact, report it
                immediately.
              </p>
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  ...
                  className="flex-1 py-4 rounded-2xl bg-orange text-white font-black shadow-lg hover:shadow-orange/30 hover:-translate-y-1 transition-all"
                >
                  Continue
                </button>
              </div>
      ...
      <VerificationPopup
        ...
        description={
          <>
            ...
            <br />
            Please go to that call to continue or cancel it before starting a
            new one.
          </>
        }
      />
