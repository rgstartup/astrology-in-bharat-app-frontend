...
export default function ChatPrepSeoContent() {
  return (
    <section className="bg-white/90 backdrop-blur-md rounded-[2rem] p-8 md:p-12 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#F0E0D0] mt-12 mb-8 relative z-20">
      
      <h2 className="text-2xl font-black text-[#1A1A1A] mb-6 flex items-center gap-3 border-b-2 border-orange inline-flex pb-2">Prepare for Your Astrological Consultation
      </h2>
      ...
      <div className="mb-10">
        <h3 className="text-xl font-black text-[#1A1A1A] mb-6">Key Topics You Can Discuss
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#FAF8F5] border border-[#EAE2D6] p-6 rounded-2xl hover:shadow-md transition-shadow">
            <h4 className="font-bold text-[#FF5500] text-[17px] mb-2 flex items-center gap-2">Career & Business
            </h4>
          ...
          <div className="bg-[#FAF8F5] border border-[#EAE2D6] p-6 rounded-2xl hover:shadow-md transition-shadow">
            <h4 className="font-bold text-[#FF5500] text-[17px] mb-2 flex items-center gap-2">Love & Marriage
            </h4>
          ...
          <div className="bg-[#FAF8F5] border border-[#EAE2D6] p-6 rounded-2xl hover:shadow-md transition-shadow">
            <h4 className="font-bold text-[#FF5500] text-[17px] mb-2 flex items-center gap-2">Wealth & Finance
            </h4>
          ...
          <div className="bg-[#FAF8F5] border border-[#EAE2D6] p-6 rounded-2xl hover:shadow-md transition-shadow">
            <h4 className="font-bold text-[#FF5500] text-[17px] mb-2 flex items-center gap-2">Remedies & Pujas
            </h4>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-6">
          <div className="bg-[#FAF8F5] p-5 rounded-2xl border border-[#EAE2D6]">
            <h4 className="font-bold text-[#FF5500] text-[16px] mb-2">What if I don't know my exact birth time?</h4>
          ...
          <div className="bg-[#FAF8F5] p-5 rounded-2xl border border-[#EAE2D6]">
            <h4 className="font-bold text-[#FF5500] text-[16px] mb-2">How is the consultation fee charged?</h4>
            <p className="text-gray-600 font-medium text-[14.5px] leading-relaxed">
