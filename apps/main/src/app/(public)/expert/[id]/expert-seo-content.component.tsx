    ...
    <section className="bg-[#edeef1] py-10 md:py-16 mt-8">
      <div className="max-w-[1320px] mx-auto px-4 md:px-8 lg:px-16">
        <div className="bg-[#1A1A1A] p-5 md:p-8 rounded-[3px] shadow-[0_4px_9px_0_rgba(0,0,0,0.08)]">
          ...
          <div className="mb-10">
            <h3 className="text-[20px] font-bold text-white mb-6 border-b-2 border-[#F26500] inline-block pb-1">Top Questions You Can Ask
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="bg-[#1A1A1A] border border-gray-800 p-5 rounded-[3px] shadow-sm hover:border-[#F26500]/30 transition-colors">
                <h4 className="font-bold text-[#F26500] text-[16px] mb-2 flex items-center gap-2">Love & Relationships
                </h4>
                <ul className="list-disc pl-5 text-[14px] text-gray-300 font-medium space-y-1">
          ...
          <div className="mb-10">
            <h3 className="text-[18px] sm:text-[20px] font-bold text-white mb-6 border-b-2 border-[#F26500] inline-block whitespace-nowrap pb-1">Frequently Asked Questions
            </h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-bold text-[#F26500] text-[16px] mb-2">How do I start a consultation?</h4>
                <p className="text-gray-300 text-[14.5px] leading-relaxed font-medium">
