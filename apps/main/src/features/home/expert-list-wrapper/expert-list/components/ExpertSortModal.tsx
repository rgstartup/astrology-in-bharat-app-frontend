...
const ExpertSortModal: React.FC<ExpertSortModalProps> = ({
  ...
  const options = [
    {
      value: "newest",
      label: t("expertSection.sortOptions.none"),
      icon: "fa-sun",
    },
    {
      value: "rating",
      label: t("expertSection.sortOptions.rating"),
      icon: "fa-star",
    },
    {
      value: "price_asc",
      label: t("expertSection.sortOptions.priceAsc"),
      icon: "fa-arrow-up-1-9",
    },
    {
      value: "price_desc",
      label: t("expertSection.sortOptions.priceDesc"),
      icon: "fa-arrow-down-9-1",
    },
    {
      value: "experience",
      label: t("expertSection.sortOptions.experience"),
      icon: "fa-briefcase",
    },
  ];
          ...
          {options.map((option) => (
            ...
            >
              ...
              <div className="ml-4 flex items-center gap-3">
                <i
                  className={`fa-solid ${option.icon} text-orange w-5 text-center`}
                ></i>
                <span
                  className={`font-bold ${sortBy === option.value ? "text-gray-900" : "text-gray-600"}`}
                >
                  {option.label}
                </span>
              </div>
