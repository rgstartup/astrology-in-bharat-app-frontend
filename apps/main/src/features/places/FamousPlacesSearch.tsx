  ...
  return (
    <div className="relative w-full" ref={ref}>
      ...
      >
        ...
        <i
          className={`fa-solid fa-chevron-down text-[10px] transition-transform ${isOpen ? "rotate-180 text-orange-400" : "text-gray-400"}`}
        />
      </button>
      ...
      {isOpen && (
        <div
          ...
          className="absolute top-full mt-1 w-full max-h-64 flex flex-col bg-white border border-[#E8D5C0] rounded-lg shadow-xl z-[100] py-1"
        >
...
const FamousPlacesSearch: React.FC<FamousPlacesSearchProps> = ({
  onSearch,
  isSearching,
}) => {
  ...
  const tx =
    {
      en: {
        ...
        search: "Search",
        toastWarning:
          "Please enter a search term or select a location before searching.",
      ...
      hi: {
        ...
        search: "खोजें",
        toastWarning:
          "खोज से पहले कृपया एक खोज शब्द दर्ज करें या एक स्थान चुनें।",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    let locationStr = [city.trim(), district.trim(), state.trim(), "India"]
      .filter(Boolean)
      .join(", ");
      ...
      (error) => {
        ...
        switch (error.code) {
          ...
          case error.POSITION_UNAVAILABLE:
            alert(
              "Location information is unavailable. Please check if your device's location services (GPS/Wi-Fi) are turned on.",
            );
            break;
          case error.TIMEOUT:
            alert(
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-[#3D1A0B] leading-tight">
                    {tx.searchTitle}
                  </h2>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                <i
                  className={`fa-solid ${isSearching ? "fa-spinner fa-spin" : "fa-magnifying-glass"}`}
                />
                {tx.search}
              </button>
            </div>
