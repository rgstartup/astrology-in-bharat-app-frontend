  ...
  hi: [
    {
      ...
      desc: "दिव्य ऊर्जा और आंतरिक शांति से जुड़ें।",
    },
    {
      icon: "fa-sun",
      title: "सकारात्मक ऊर्जा",
      desc: "नकारात्मकता दूर करें और सकारात्मकता को आकर्षित करें।",
    },
    {
      icon: "fa-star",
      title: "ज्योतिष लाभ",
      desc: "अपनी राशि और ग्रहों के लिए अनुशंसित मंदिर जाएं।",
    },
    {
      icon: "fa-landmark",
      title: "सांस्कृतिक विरासत",
      desc: "भारत की समृद्ध आध्यात्मिक और सांस्कृतिक विरासत को जानें।",
    },
  ],
};
    ...
    >
      ...
      <div className="relative z-10 max-w-[70%] md:max-w-[65%]">
        ...
        <div className="inline-flex items-center justify-center gap-1.5 bg-[#F26500] hover:bg-[#d95a00] text-white text-[10px] md:text-[11px] font-bold px-3 py-2 md:px-4 md:py-2.5 rounded-lg transition-colors shadow-sm whitespace-nowrap">
          <i className="fa-solid fa-star-and-crescent text-[9px] md:text-[10px]" />{" "}
          {tx.btn}
        </div>
      </div>
    </Link>
    ...
    <div className="bg-[#FCF8F4] rounded-2xl border border-[#E8D5C0] shadow-sm p-5">
      ...
      <div className="flex items-start gap-4">
        <div className="w-[60px] h-[60px] rounded-full overflow-hidden flex-shrink-0 relative shadow-sm border border-[#E8D5C0]">
          <Image
            src="/images/ekadashi-special.jpg"
            alt="Ekadashi"
            fill
        ...
        <div>
          <p className="text-[13px] font-bold text-[#D35400] mb-1">
            {tx.title}
          </p>
          <p className="text-[11px] font-medium text-gray-700 leading-relaxed pr-2">
            {tx.desc}
          </p>
...
export const AskExpertSidebar = () => {
  ...
  const tx = {
    en: {
      need: "Need Guidance?",
      title: "Talk to an Astrology Expert",
      btn: "Talk to Expert",
    },
    hi: {
      need: "मार्गदर्शन चाहिए?",
      title: "ज्योतिषी से बात करें",
      btn: "विशेषज्ञ से बात करें",
    },
  }[lang];
