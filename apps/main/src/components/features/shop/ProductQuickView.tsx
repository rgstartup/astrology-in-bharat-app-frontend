...
const ProductQuickView: React.FC<ProductQuickViewProps> = ({
  ...
  const originalPrice =
    Number(product.originalPrice || (product as any).original_price) || price;
  const discount =
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <span className="text-[10px] font-black text-orange uppercase tracking-[0.3em] font-outfit">
                  Spiritual Artifacts
                </span>
              ...
              <h2 className="text-3xl lg:text-4xl font-black text-slate-900 tracking-tighter uppercase leading-tight">
                {product.name}
              </h2>
            ...
            <div className="bg-white px-8 py-6 rounded-[2rem] border border-orange/10 shadow-xl shadow-orange/5 flex items-center justify-between group/price">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-lg font-bold text-gray-300 line-through decoration-orange/40 decoration-2">
                    ₹{originalPrice}
                  </span>
                </div>
              </div>
              <div className="flex flex-col items-end">
                <span className="px-3 py-1 bg-orange/10 text-orange rounded-full text-[10px] font-black uppercase tracking-widest border border-orange/10">
                  Limited Slot
                </span>
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-500 font-medium text-base leading-relaxed">
                {product.description ||
                  "This sacred artifact has been meticulously handcrafted and energized by renowned practitioners to ensure peak spiritual vibration and protection for your space."}
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-start gap-3 p-4 bg-white/30 rounded-2xl border border-white/50">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-slate-400 font-bold uppercase leading-none mt-1">
                    100% Authentic
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6 pt-4">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex gap-4">
                  ...
                  >
                    <Heart
                      className={`w-6 h-6 group-hover/heart:fill-red-500 ${isLiked ? "fill-red-500" : ""} transition-all`}
                    />
                  </button>
                </div>
                <button
