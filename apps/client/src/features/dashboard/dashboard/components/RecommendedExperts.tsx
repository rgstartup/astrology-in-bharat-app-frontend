    ...
    <div className="mb-8 sm:mb-10">
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <Card key={i} className="p-4 border-slate-200 bg-white space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {experts.slice(0, 4).map((expert: any) => {
            ...
            return (
              <Card
                key={expert.id}
                className="border-slate-200 bg-white hover:shadow-md transition-all duration-200 p-4 sm:p-5 flex flex-col justify-between"
              >
                <div>
