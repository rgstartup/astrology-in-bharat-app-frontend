      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {activities.map((item) => (
            ...
            >
              <Card className="p-4 border-slate-200 bg-white hover:border-slate-300 hover:shadow-xs transition-all flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <div className="w-6 h-6 rounded-full bg-slate-50 group-hover:bg-slate-100 flex items-center justify-center text-slate-400 group-hover:text-[#ff6b00] transition-colors">
