      ...
      <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
          <div>
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                <h5 className="font-bold text-white text-xl md:text-2xl tracking-tight m-0">
                  {t.title}
                </h5>
                <p className="text-gray-400 text-sm m-0">{t.subtitle}</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-10 bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 relative overflow-hidden group hover:bg-white/15 transition-all duration-500 shadow-2xl">
          <div className="relative z-10 text-center">
            <p className="text-white/60 text-[10px] font-bold uppercase mb-3 tracking-[0.2em]">
              <i className="fa-solid fa-circle-info mr-2 opacity-50"></i>
              {t.availableBalance}
            </p>
            <div className="flex items-center justify-center mb-2">
              <span className="text-orange text-xl md:text-3xl font-bold mr-1 md:mr-2 mt-1">
                ₹
              </span>
        ...
        {walletView === "recharge" ? (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="mb-10">
              <div className="flex items-center mb-3">
                ...
                <h6 className="font-bold text-gray-900 text-xl m-0">
                  {t.addMoneyTitle}
                </h6>
              </div>
              <p className="text-gray-500 text-sm ml-14 leading-relaxed max-w-2xl">
                {t.addMoneySubtitle}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start mb-10">
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="bg-gray-50/80 p-6 rounded-2xl border border-gray-100 shadow-sm">
                  <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-4 flex items-center">
                  ...
                  <p className="text-gray-400 text-[11px] mt-4 font-medium italic">
                    {t.customAmountHint}
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-2">
                <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-4 flex items-center ml-1">
                  ...
                  {rechargeOptions.map((amt) => (
                    ...
                    >
                      ...
                      <div className="flex items-center transition-transform group-hover:scale-110 duration-300">
                        <span className="text-xs md:text-sm font-bold mr-1 text-gray-400 mt-0.5">
                          ₹
                        </span>
                        <span
              ...
              >
                <div className="flex items-center justify-between w-full px-2 md:px-4">
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
                    <div className="text-white text-base md:text-xl font-black tracking-tight">
                      {t.rechargeBtn} ₹{rechargeAmount.toLocaleString()}
                    </div>
                    <div className="hidden md:block text-white/70 text-[9px] md:text-[11px] font-bold uppercase tracking-wider mt-0.5">
                      {t.rechargeHint}
                    </div>
                  </div>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-6 sm:mb-8 px-2 sm:px-0">
              <h6 className="font-bold text-gray-900 text-xl m-0 flex items-center">
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-gray-50/50 border-b border-gray-100">
                      <th className="px-4 sm:px-8 py-4 sm:py-5 text-[10px] uppercase font-bold tracking-widest text-gray-400">
                        {t.tableDate}
                      </th>
                      <th className="px-4 sm:px-8 py-4 sm:py-5 text-[10px] uppercase font-bold tracking-widest text-gray-400">
                        {t.tableDescription}
                      </th>
                      <th className="px-4 sm:px-8 py-4 sm:py-5 text-[10px] uppercase font-bold tracking-widest text-gray-400 text-center">
                        {t.tableType}
                      </th>
                      <th className="px-4 sm:px-8 py-4 sm:py-5 text-[10px] uppercase font-bold tracking-widest text-gray-400 text-right">
                        {t.tableAmount}
                      </th>
                      <th className="px-4 sm:px-8 py-4 sm:py-5 text-[10px] uppercase font-bold tracking-widest text-gray-400 text-right">
                        {t.tableStatus}
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {loadingTransactions ? (
                      ...
                      transactions.map((tx: any, idx: number) => {
                        ...
                        const isNegative = ["debit", "hold"].includes(
                          tx.type?.toLowerCase(),
                        );
                          ...
                          >
                            ...
                            <td className="px-4 sm:px-8 py-4 sm:py-6">
                              ...
                              <p className="text-[10px] font-medium text-gray-400 mt-0.5 m-0 uppercase tracking-wider">
                                ...
                                {tx.transaction_no ||
                                  (tx.id
                                    ? `#${String(tx.id).slice(-8).toUpperCase()}`
                                    : "INTERNAL")}
                              </p>
                            </td>
                            <td className="px-4 sm:px-8 py-4 sm:py-6 text-center">
                ...
                transactions.length > 0 && (
                  <div className="flex flex-col items-center justify-center py-8 border-t border-dashed border-gray-100 bg-gray-50/20">
                    ...
                    <p className="text-gray-400 text-xs font-medium">
                      {lang === "hi"
                        ? "आपने सभी लेनदेन देख लिए हैं"
                        : "You've viewed all transactions"}
                    </p>
                  </div>
                )
              )}
