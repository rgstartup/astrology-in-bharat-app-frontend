  ...
  return (
    <div className="hidden lg:grid grid-cols-3 gap-3 pt-0.5">
      ...
      <button
        type="button"
        onClick={onChatClick}
        className="group/chat flex items-center justify-between p-3 sm:p-3.5 rounded-xl bg-orange-50/70 hover:bg-orange-50/95 border border-orange-200/60 text-slate-900 transition-all cursor-pointer hover:border-orange-300/80 active:scale-[0.99] shadow-2xs"
      >
      ...
      <button
        type="button"
        onClick={onCallClick}
        className="group/call flex items-center justify-between p-3 sm:p-3.5 rounded-xl bg-emerald-50/70 hover:bg-emerald-50/95 border border-emerald-200/60 text-slate-900 transition-all cursor-pointer hover:border-emerald-300/80 active:scale-[0.99] shadow-2xs"
      >
        <div className="flex items-center gap-2.5 min-w-0">
      ...
      <button
        ...
        className="group/video flex items-center justify-between p-3 sm:p-3.5 rounded-xl bg-indigo-50/70 hover:bg-indigo-50/95 border border-indigo-200/60 text-slate-900 transition-all cursor-pointer hover:border-indigo-300/80 active:scale-[0.99] shadow-2xs"
      >
        <div className="flex items-center gap-2.5 min-w-0">
