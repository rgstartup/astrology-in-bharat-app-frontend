...
export default function MyKundliPage() {
  ...
  if (!hasBirthDetails) {
    return (
      <div className="max-w-2xl mx-auto py-12 text-center animate-in fade-in duration-300">
        <Card className="border-2 border-dashed border-slate-200 p-8 sm:p-12 bg-white text-center">
          <div className="w-16 h-16 rounded-3xl bg-slate-100 text-[#ff6b00] flex items-center justify-center mx-auto mb-4 shadow-sm">
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300">
      ...
      <Card className="border-slate-200 bg-white shadow-xs p-6 sm:p-8">
      ...
      <div className="flex overflow-x-auto pb-2 border-b border-slate-200 gap-1.5 sm:gap-2 no-scrollbar">
        {tabs.map((tab) => {
          const Icon = tab.icon;
      ...
      <div>
        ...
        {activeTab === "chart" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8">
              <Card className="p-6 sm:p-8 border-slate-200 bg-white shadow-sm flex flex-col items-center justify-center">
                ...
                <div className="w-full max-w-md aspect-square relative my-4">
                  ...
                  >
                    ...
                    <text
                      ...
                      y="100"
                      textAnchor="middle"
                      className="font-bold text-xs fill-slate-700"
                    >
                      1 (Lagna)
                    </text>
                    <text
              ...
              <table className="w-full text-left text-xs border-collapse">
                ...
                <tbody className="divide-y divide-slate-100 text-slate-800">
                  {SAMPLE_PLANETS_TABLE.map((row) => (
                    <tr key={row.planet} className="hover:bg-slate-50 transition-colors">
        ...
        {activeTab === "houses" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {SAMPLE_HOUSES_LIST.map((h) => (
              <Card key={h.house} className="p-4 border-slate-200 bg-white">
        ...
        {/* 4. NAKSHATRA TAB */}
        {activeTab === "nakshatra" && (
          <Card className="p-6 sm:p-8 border-slate-200 bg-white space-y-6">
        ...
        {activeTab === "yogas" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {SAMPLE_YOGAS_LIST.map((y) => (
              <Card key={y.name} className="p-5 border-slate-200 bg-white">
        ...
        {/* 8. REPORTS TAB */}
        {activeTab === "reports" && (
          <Card className="p-8 border-slate-200 bg-white text-center">
