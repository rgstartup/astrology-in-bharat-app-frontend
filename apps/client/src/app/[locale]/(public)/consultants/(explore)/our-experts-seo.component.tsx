    ...
    <section className="bg-[#edeef1] py-10 md:py-16 mt-8">
      <div className="max-w-[1320px] mx-auto px-4 md:px-8 lg:px-16">
        <div className="bg-white p-5 md:p-8 rounded-[3px] shadow-[0_4px_9px_0_rgba(0,0,0,0.08)]">
          ...
          <h2 className="text-2xl font-black text-[#1A1A1A] mb-6 flex items-center gap-3 border-b-2 border-[#F26500] inline-flex pb-2">Connect with India's Most Trusted Astrologers
          </h2>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-5 mb-10 rounded-r-md">
            <h3 className="text-[17px] font-bold text-blue-900 mb-2 flex items-center gap-2">Our Rigorous 3-Step Verification Process
            </h3>
          ...
          <div className="mb-10">
            <h3 className="text-[20px] font-bold text-black mb-6 border-b-2 border-[#F26500] inline-block pb-1">Explore Diverse Areas of Expertise
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="bg-white border border-gray-200 p-5 rounded-[3px] shadow-sm hover:border-[#F26500]/30 transition-colors">
                <h4 className="font-bold text-[#F26500] text-[16px] mb-2 flex items-center gap-2">Vedic Astrology (Jyotish)
                </h4>
              ...
              <div className="bg-white border border-gray-200 p-5 rounded-[3px] shadow-sm hover:border-[#F26500]/30 transition-colors">
                <h4 className="font-bold text-[#F26500] text-[16px] mb-2 flex items-center gap-2">Tarot Card Reading
                </h4>
              ...
              <div className="bg-white border border-gray-200 p-5 rounded-[3px] shadow-sm hover:border-[#F26500]/30 transition-colors">
                <h4 className="font-bold text-[#F26500] text-[16px] mb-2 flex items-center gap-2">Numerology
                </h4>
              ...
              <div className="bg-white border border-gray-200 p-5 rounded-[3px] shadow-sm hover:border-[#F26500]/30 transition-colors">
                <h4 className="font-bold text-[#F26500] text-[16px] mb-2 flex items-center gap-2">Vastu Shastra
                </h4>
