        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-7 space-y-10 order-2 lg:order-1">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-5 py-2 bg-white/5 backdrop-blur-md rounded-full border border-white/10 shadow-2xl">
                ...
                <span className="text-[10px] font-black text-white/80 uppercase tracking-[0.3em]">
                  Lunar Intelligence Audit
                </span>
              </div>

              <h1 className="text-5xl md:text-7xl font-black text-white leading-[1.1] tracking-tight">
                Moon Sign <span className="text-indigo-400 italic">Rashi</span>{" "}
                <br />
              ...
              <p className="text-xl font-bold text-gray-400 leading-relaxed max-w-2xl italic border-l-4 border-indigo-400/30 pl-8">
                &quot;Your moon sign represents your inner emotional world and
                needs. It governs your intuition, vulnerability, and instinctive
                reactions.&quot;
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                >
                  ...
                  <span className="text-[11px] font-black text-white/90 uppercase tracking-[0.2em]">
                    {item.text}
                  </span>
                </div>
              ))}
            ...
            <div className="pt-6 flex flex-wrap gap-6 items-center">
              <button className="group relative px-12 py-6 bg-indigo-600 text-white rounded-3xl font-black text-xs uppercase tracking-[0.4em] shadow-2xl shadow-indigo-500/20 hover:bg-white hover:text-slate-950 transition-all duration-500 active:scale-[0.98] overflow-hidden">
              ...
              <div className="relative bg-white/5 rounded-[4rem] border border-white/10 backdrop-blur-sm p-16 shadow-2xl overflow-hidden group-hover:-translate-y-4 transition-transform duration-700 flex flex-col items-center justify-center min-h-[400px]">
                ...
                <div className="relative">
                  ...
                  {[...Array(3)].map((_, i) => (
                    <div
                      key={i}
                      className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 border border-white/10 rounded-full animate-[spin_${20 + i * 10}s_linear_infinite]`}
                      style={{
                ...
                <div className="absolute bottom-12 right-12 px-6 py-4 bg-slate-950/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl animate-bounce">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-indigo-500 rounded-xl flex items-center justify-center text-white font-black text-xl italic shadow-lg">
                      M
                    </div>
                    <div>
