            ...
            {menuOptions.map((stat, i) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <span className="text-yellow-500 text-lg group-hover/item:scale-110 transition-transform">
                    {stat.icon}
                  </span>
        ...
        <div className="bg-yellow-50/50 rounded-[2.5rem] p-10 border border-yellow-100/50 shadow-premium relative overflow-hidden group">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-5 group/item">
              ...
              <div className="space-y-1">
                <p className="text-[8px] font-black text-emerald-600 uppercase tracking-widest leading-none">
                  Best Synergy
                </p>
            ...
            <div className="flex items-start gap-5 group/item">
              ...
              <div className="space-y-1">
                <p className="text-[8px] font-black text-red-500 uppercase tracking-widest leading-none">
                  Potential Conflict
                </p>
                <p className="text-sm font-bold text-gray-700 italic pr-4 mt-1">
                  Scorpio, Aquarius
          ...
          <button className="group/btn relative w-full mt-10 px-8 py-5 bg-gray-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] overflow-hidden shadow-2xl hover:bg-yellow-600 transition-all duration-500">
            ...
            <span className="relative z-10 flex items-center justify-center gap-4">
              Audit Full Compatibility{" "}
              <FaArrowRight className="text-[10px] group-hover/btn:translate-x-2 transition-transform" />
            </span>
          </button>
        </div>
      </div>
