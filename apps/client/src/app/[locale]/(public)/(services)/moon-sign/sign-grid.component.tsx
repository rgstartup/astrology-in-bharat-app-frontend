    ...
    <section className="py-24 bg-slate-50/50 relative overflow-hidden">
          ...
          <div className="text-center mb-20 space-y-6">
            <div className="inline-flex items-center gap-3 px-5 py-2 bg-indigo-50 rounded-full border border-indigo-100">
              ...
              <span className="text-[10px] font-black text-indigo-900 uppercase tracking-[0.3em]">
                Lunar Selection Protocol
              </span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight">
              Identifty Your{" "}
              <span className="text-indigo-600 italic">Moon Sign</span>
            </h2>
            <p className="text-lg font-bold text-gray-400 italic leading-relaxed max-w-2xl mx-auto">
              &quot;Select your rashi to explore daily emotional forecast and
              deep-seated lunar insights based on Vedic calculations.&quot;
            </p>
          </div>
      ...
      <div className="mt-12 text-center opacity-30">
        <div className="flex items-center justify-center gap-4">
          ...
          <span className="text-[8px] font-black text-gray-900 uppercase tracking-[0.4em]">
            Precise Vedic Lunar Chart System
          </span>
          <div className="h-[1px] w-24 bg-gray-300"></div>
        </div>
      </div>
