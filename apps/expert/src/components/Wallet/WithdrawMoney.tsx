...
export default function WithdrawMoney({ availableBalance, bankAccounts, onWithdraw, isLoading }: WithdrawMoneyProps) {
    ...
    return (
        <div className="group bg-white p-6 sm:p-10 rounded-none sm:rounded-[1.5rem] border-2 border-orange-400 shadow-none sm:shadow-sm space-y-6 sm:space-y-8 relative overflow-hidden transition-all duration-700 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.05)] sm:hover:-translate-y-1 sm:mb-8">
