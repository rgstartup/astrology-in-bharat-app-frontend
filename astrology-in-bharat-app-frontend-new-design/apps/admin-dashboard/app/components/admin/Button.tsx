...
export function Button({
  ...
  const variants = {
    primary:
      "bg-orange-500 hover:bg-orange-600 text-white shadow-md focus:ring-orange-400",
    secondary:
...
//   const variants = {
//     primary:
//       "bg-gray-900 hover:bg-black text-white shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 focus:ring-gray-700", // ✅ Changed to pin/black
//     secondary:
...
//     outline:
//       "bg-white border-2 border-gray-300 hover:bg-gray-50 hover:border-gray-900 text-gray-700 focus:ring-gray-400", // ✅ Updated hover border
//   };
