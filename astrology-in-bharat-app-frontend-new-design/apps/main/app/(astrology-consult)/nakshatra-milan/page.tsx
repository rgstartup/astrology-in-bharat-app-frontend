                  ...
                  <div className="hero-card shine">
                    <div className="card-z">
                      ...
                      <h4 className="card-title">
                        Meld Your Destinies Together
                      </h4>
                      <p>
                        birth stars. This ancient method evaluates relationship
                        harmony and long-term stability.
                      </p>
                      <ul className="list-check">
                        <li>
                          <i className="fa-solid fa-check"></i> Star
                          Compatibility
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i> Vedic Scoring
                          System
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i> Mental &
                          Physical Sync
                        </li>
                        <li>
