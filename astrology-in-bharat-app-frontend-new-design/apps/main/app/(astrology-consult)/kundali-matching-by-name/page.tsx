...
import { FaUserFriends as FaUf, FaArrowLeft as FaAl } from "react-icons/fa";
                  ...
                  <div className="hero-card shine">
                    <div className="card-z">
                      ...
                      <p>
                        ...
                        the power of names. A perfect tool for quick
                        compatibility insights based on Vedic Namank astrology.
                      </p>
                      <ul className="list-check">
                        <li>
                          <i className="fa-solid fa-check"></i> Instant
                          Name-Based Compatibility
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i> Vedic Numerology
                          Analysis
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i> Gun Milan Logic
                          Applied
                        </li>
                        <li>
